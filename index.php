		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="su_NID" class="form-control input_user" placeholder="NID" required />
                                </div>
                ...
                <?php
                        ...
                        ?>
                                <span class="bg-white text-danger text-center my-3"> Invalid NID or password! </span>
                        <?php
                            }
                ?>
...
<?php 
    ...
    if(isset($_POST['sign_up_btn']))
    {
        ...
        $su_NID = mysqli_real_escape_string($db, $_POST['su_NID']);
        ...
        if($su_password == $su_retype_password) 
        {
            ...
            mysqli_query($db, "INSERT INTO users(username, NID, contact_no, password, user_role) VALUES('". $su_username ."', '". $su_NID ."',  '". $su_contact_no ."',  '". $su_password ."', '". $user_role ."')") or die(mysqli_error($db));
